...
public class ImageService : IImageService
{
    public async Task<string> CreateImageAsync(SocketGuildUser user)
    {
        ...
        var background = await FetchImageAsync("https://images.unsplash.com/photo-1500829243541-74b677fecc30?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1055&q=80");
    ...
    private async Task<Image> FetchImageAsync(string url)
    {
        ...
        {
            var backupResponse = await client.GetAsync("https://images.unsplash.com/photo-1500829243541-74b677fecc30?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1055&q=80");
    ...
    private Image CopyRegionIntoImage(Image source, Image destination)
    {
        ...
        g.DrawImage(source, x, y, 220, 220);
        return destination;
    }
    ...
    private Image DrawTextToImage(Image image, string header, string subheader)
    {
        ...
        var brushGray = new SolidBrush(ColorTranslator.FromHtml("#B3B3B3"));
        ...
        g.DrawString(header, roboto, brushWhite, headerX, headerY, drawFormat);
        g.DrawString(subheader, robotoSmall, brushGray, subheaderX, subheaderY, drawFormat);
